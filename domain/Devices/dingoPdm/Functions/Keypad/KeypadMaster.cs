...
public class KeypadMaster : IDeviceFunction
{
    ...
    private void InitParams()
    {
        ...
        [
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "model", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "backlightBrightness", Index = BaseIndex + (Number - 1),
                SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "dimBacklightBrightness", Index = BaseIndex + (Number - 1),
                SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "backlightColor", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "dimmingVar", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "buttonBrightness", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "dimButtonBrightness", Index = BaseIndex + (Number - 1),
                SubIndex = subIndex++,
