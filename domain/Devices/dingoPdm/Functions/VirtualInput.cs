...
public class VirtualInput : IDeviceFunction
{
    ...
    private List<DeviceParameter> InitParams()
    {
        ...
        [
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "not0", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "cond0", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "not1", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "cond1", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "not2", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
            ...
            new DeviceParameter
            {
                ParentName = Name, Name = "cond2", Index = BaseIndex + (Number - 1), SubIndex = subIndex++,
